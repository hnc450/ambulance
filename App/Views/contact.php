                    ...
                    <form id="contactForm" class="contact-form" method="POST" action="/contactez">
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" id="nom" name="nom" required value="<?=$_SESSION['user'][0]['nom']?>">
                            </div>
                            
                            <div class="form-group">
                                <label for="prenom">Genre</label>
                                <input type="text" id="prenom" name="genre" required value="<?=$_SESSION['user'][0]['genre']?>">
                            </div>
                        </div>
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="email" id="email" name="email" required value="<?=$_SESSION['user'][0]['email']?>">
                            </div>
                            
                            <div class="form-group">
                                <label for="telephone">Téléphone</label>
                                <input type="tel" id="telephone" name="telephone" required value="<?=$_SESSION['user'][0]['phone']?>">
                            </div>
                        </div>
