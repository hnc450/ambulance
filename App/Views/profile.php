            ...
            <div class="profile-header">
                <div class="profile-cover">
                    <div class="profile-avatar">
                        <img src="<?= $_SESSION['user'][0]['genre'] === 'Masculin' ? './assets/photos/male.png' : './assets/photos/female.png' ?>">
                ...
                <div class="profile-info">
                    <h2> <?=$_SESSION['user'][0]['nom']?></h2>
                    <p class="profile-status"><i class="fas fa-circle" style="color:<?= $_SESSION['user'][0]['status'] ? 'green': '' ?>;"></i> 
                       <?= $_SESSION['user'][0]['status'] ? "Online" : "Offline"?>
                    </p>
            ...
            <div class="profile-content">
                    ...
                    <div class="profile-section">
                        ...
                        <div class="info-grid">
                            <div class="info-item">
                                ...
                                <span class="info-value"><?=$_SESSION['user'][0]['nom']?></span>
                            </div>
                            <div class="info-item">
                                <span class="info-label">Email</span>
                                <span class="info-value"><?=$_SESSION['user'][0]['email']?></span>
                            </div>
                            <div class="info-item">
                                <span class="info-label">Téléphone</span>
                                <span class="info-value"><?=$_SESSION['user'][0]['phone']?></span>
                            </div>
                            <div class="info-item">
                            ...
                            <div class="info-item">
                                ...
                                <span class="info-value"> <?= $_SESSION['user'][0]['addresses'] ?? '-----'?> </span>
                            </div>
                            <div class="info-item">
                                <span class="info-label">Membre depuis</span>
                                <span class="info-value"><?=$_SESSION['user'][0]['date_creation']?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="profile-section">
                        ...
                        <div class="info-grid">
                            ...
                            <div class="info-item">
                                ...
                                <span class="info-value"><?=$_SESSION['user'][0]['genre'] ?></span>
                            </div>
                ...
                <div class="tab-content" id="settings">
                        ...
                        <form class="settings-form">
                            <div class="form-group">
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="email" id="email" name="email" value="<?=$_SESSION['user'][0]['email']?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="tel" id="phone" name="phone" value="<?=$_SESSION['user'][0]['phone']?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="text" id="address" name="address" value="<?= $_SESSION['user'][0]['addresses'] ?? '------' ?>">
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="profile-section">
                        ...
                        <form class="settings-form" method="POST" action="/UpdatePassword">
                            <div class="form-group">
                        ...
                        <div class="danger-actions">
                            ...
                            <div class="danger-action">
                                ...
                                <!--
                                     ...
                                     exemple /users/2
                                  -->
                             <form action="/user/<?= $_SESSION['user'][0]['id']?>" method="POST">
